...
const ProfessionalSummaryForm = ({data , onChange, setResumeData}) => {
    ...
    const generateSummary = async () => {
        ...
        try {
            ...
            const response = await api.post('/api/ai/enhanced-pro-sum', {userContent: prompt}, {headers: {Authorization: token} })
  ...
  return (
    <div className='space-y-4'>
        <div className='flex items-center justify-between'>
            <div>
                <h3 className='flex items-center grap-2 yexy-lg font-semibold text-gray-900'>Professional Summary</h3>
        ...
        <div className='mt-6'>
            ...
            <p className='text-xs text-gray-500 max-w-4/5 mx-auto text-center'>
                Tip: Keep it concise (3-4 sentences) and focus on your most relevant acheivements and skills.
            </p>
