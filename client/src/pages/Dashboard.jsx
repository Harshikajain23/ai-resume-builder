import { FilePenLineIcon, Form, PencilIcon, Plus, TrashIcon, UploadCloudIcon, XIcon } from 'lucide-react'
      ...
      <div className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <div className='flex gap-4'>
          <button onClick={()=> setShowCreateResume(true)} className='w-full bg-white sm:max-w-36 h-48 flex flex-col items-center justify-center rounded-lg gap-2 text-slate-600 border border-dashed border-slate-300 group hover:border-purple-500 hover:shadow-lg transition-all duration-300 cursor-pointer'>
            <Plus className='size-11 transition-all duration-300 p-2.5 bg-gradient-to-br from-purple-300 to-purple-500 text-white rounded-full'/>
          ...
          {/* {
            showUploadResume && (
              <form onSubmit={uploadResume} onClick={()=> setShowUploadResume(false)} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
                ...
                <button className='w-full py-2 bg-[#a118bdfe] text-white rounded hover:bg-[#650f5e] transition-colors'>Upload Resume</button>
