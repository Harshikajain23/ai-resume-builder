...
import { ArrowLeftIcon, Briefcase, ChevronLeft, ChevronRight, Download, DownloadIcon, EyeClosedIcon, EyeIcon, EyeOffIcon, FileText, FolderIcon, GraduationCap, Share2, Share2Icon, Sparkles, User } from 'lucide-react'
...
const ResumeBuilder = () => {
  ...
  try {
    ...
    console.log("Image being sent:", resumeData.personal_info.image);
    console.log("Is File?", resumeData.personal_info.image instanceof File);
    ...
    if (resumeData.personal_info.image instanceof File) {
      formData.append("image", resumeData.personal_info.image); // append the file
      removeBackground && formData.append("removeBackground", "yes"); // optional
    }
    ...
    console.error("Error saving resume:", error);
    toast.error("For saving, you need to remove your image")
  }
};
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              {/* progress bar using setActiveSectionIndex */}
              <hr className='absolute top-0 left-0 right-0 border-2 border-gray-200'/>
            <hr className='absolute top-0 left-0 h-1 bg-gradient-to-r from-[#c11ebb] to-[#7d137a] border-none transition-all duration-2000' style={{width: `${activeSectionIndex * 100/ (sections.length-1)}%`}}/>
            ...
            <div className='flex justify-between items-center mb-6 border-b border-gray-300 py-1'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <ColorPicker seletedColor={resumeData.accent_color} onChange={(color)=> setResumeData(prev => ({...prev, accent_color: color}) ) }/>
              </div>
